...
def load_data(catalog, filename):
    ...
    with open(relationships, mode='r') as csv_file:    
        ...
        catalog["vertices"]['table'] = relationshipsdict
    ...
    with open(userinfo, mode='r') as csv_file:    
        ...
        catalog['information']['table']['elements'] = relationshipsdict
        catalog['information']['table']['size'] = len(relationshipsdict) # Actualiza Size
        catalog['vertices']['table']['elements'] = userdict
        catalog['vertices']['table']['size'] = len(userdict) # Actualiza Size
